...
m.data_info.training_files={'~sturaga/net_sets/BSD/minimax/bsds500_trainval'};
%m.data_info.training_files={'~sturaga/data/BSDS300/train_color'};
%m.data_info.training_files={'~sturaga/net_sets/BSD/minimax/train_color_flp'};
