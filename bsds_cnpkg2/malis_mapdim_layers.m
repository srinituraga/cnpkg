...
%% Setup the layer sizes for activity layers
% output layer
m.layers{m.layer_map.big_output}.size{5} = 1;
...
m.layers{m.layer_map.big_label}.size{5} = 1;
m.layers{m.layer_map.big_label}.val = 0;
m.layers{m.layer_map.big_label}.mask = 0;

m.layers{m.layer_map.big_output}.size{2} = graph_size(1);
m.layers{m.layer_map.big_output}.y_start = 0;
m.layers{m.layer_map.big_output}.y_space = 1;
m.layers{m.layer_map.big_output}.size{3} = graph_size(2);
m.layers{m.layer_map.big_output}.x_start = 0;
m.layers{m.layer_map.big_output}.x_space = 1;
m.layers{m.layer_map.big_output}.size{4} = graph_size(3);
m.layers{m.layer_map.big_output}.d_start = 0;
m.layers{m.layer_map.big_output}.d_space = 1;
m = cns_mapdim(m, m.layer_map.big_label, 2, 'copy', m.layer_map.big_output);
m = cns_mapdim(m, m.layer_map.big_label, 3, 'copy', m.layer_map.big_output);
m = cns_mapdim(m, m.layer_map.big_label, 4, 'copy', m.layer_map.big_output);
% hidden layers
