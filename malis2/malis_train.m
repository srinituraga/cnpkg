function m = malis_train(m,show_plot,platform,nice,skip_gpu_init)
...
% fprintf('everything in between...'),tic
	...
	%% Compute MALIS loss -------------------------------------------------------
    [dlossNeg,loss(1),classerr(1),randIndex(1)] = malis_loss_balanced( ...
                                                connEst(:,:,:,:,1), ...
                                                m.params.nhood, ...
                                                segNeg, ...
                                                0.5, ...
                                                ...
                                                false, true);
    [dlossPos,loss(2),classerr(2),randIndex(2)] = malis_loss_balanced( ...
                                                connEst(:,:,:,:,2), ...
                                                m.params.nhood, ...
                                                segPos, ...
                                                0.5, ...
    ...
    dlossNeg = -dlossNeg .* connEst(:,:,:,:,1).*(1-connEst(:,:,:,:,1));
    dlossPos = -dlossPos .* connEst(:,:,:,:,2).*(1-connEst(:,:,:,:,2));
