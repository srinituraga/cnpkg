...
#----------------------------------------------------------------------------
            ...
            # CkeyVersion:
            CC=nvcc
            CFLAGS="-Xcompiler '-ansi -m32 -D_GNU_SOURCE -fPIC -pthread -fexceptions -D_FILE_OFFSET_BITS=64'"
...
#----------------------------------------------------------------------------
            ...
            # CkeyVersion:
            CC=nvcc
            CFLAGS="-Xcompiler '-ansi -D_GNU_SOURCE -fexceptions -fPIC -fno-omit-frame-pointer -pthread'"
            CLIBS="$RPATH $MLIBS -lm -lstdc++"
            COPTIMFLAGS='-O -DNDEBUG'
            CDEBUGFLAGS='-g'
            CLIBS="$CLIBS -lstdc++"
...
#----------------------------------------------------------------------------
            ...
            ARCHS='i386'
            CFLAGS="-m32 -Xcompiler '-fno-common -no-cpp-precomp -arch $ARCHS -isysroot $SDKROOT -mmacosx-version-min=$MACOSX_DEPLOYMENT_TARGET -fexceptions'"
            CLIBS="$MLIBS"
...
#----------------------------------------------------------------------------
            ...
            MACOSX_DEPLOYMENT_TARGET='10.5'
            ARCHS='x86_64'
            CFLAGS="-m64 -Xcompiler '-fno-common -fexceptions -no-cpp-precomp -arch $ARCHS -isysroot $SDKROOT -mmacosx-version-min=$MACOSX_DEPLOYMENT_TARGET'"
            CLIBS="$MLIBS"
            COPTIMFLAGS='-O2 -DNDEBUG'
            CDEBUGFLAGS='-g'
#
