function varargout = cns_findwithin_at(m, pz, dim, p, r)

% CNS_FINDWITHIN_AT
%    Click <a href="matlab: cns_help('cns_findwithin_at')">here</a> for help.
...
c1 = ceil ((p - r - s) * dd - 0.001);
c2 = floor((p + r - s) * dd + 0.001);
