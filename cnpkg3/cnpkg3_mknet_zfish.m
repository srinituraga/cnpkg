...
m.data_info.training_file = '~sturaga/net_sets/RainerFriedrich/cnpkg/zfish_ob1_set1';
m.data_info.testing_file = '~sturaga/net_sets/RainerFriedrich/cnpkg/zfish_ob1_set1';
...
m.params.layer{l}.patchSz{end+1} = [1 1 1]*5;
m.params.layer{l}.wPxSize{end+1} = [1 1 1]*1;
% m.params.layer{l}.nHid{end+1} = 4;
% m.params.layer{l}.scales{end+1} = [1 1 1];
% m.params.layer{l}.patchSz{end+1} = [1 1 1]*5;
% m.params.layer{l}.wPxSize{end+1} = [1 1 1]*3;
% m.params.layer{l}.nHid{end+1} = 3;
% m.params.layer{l}.scales{end+1} = [1 1 1];
% m.params.layer{l}.patchSz{end+1} = [1 1 1]*5;
% m.params.layer{l}.wPxSize{end+1} = [1 1 1]*5;
% m.params.layer{l}.nHid{end+1} = 3;
% m.params.layer{l}.scales{end+1} = [1 1 1];
% m.params.layer{l}.patchSz{end+1} = [1 1 1]*5;
% m.params.layer{l}.wPxSize{end+1} = [1 1 1]*7;
% m.params.layer{l}.nHid{end+1} = 12;
% m.params.layer{l}.scales{end+1} = [1 1 1];
% m.params.layer{l}.patchSz{end+1} = [1 1 1]*5;
% m.params.layer{l}.wPxSize{end+1} = [1 1 1]*9;
...
m.params.layer{m.params.num_layers}.patchSz{1} = [1 1 1]*5;
