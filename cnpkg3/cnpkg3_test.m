function [output,leftBorder,rightBorder] = cnpkg3_test(m,testing_set,zero_pad,show_plot)
...
for k = 1:nInput,
	...
	if zero_pad,
		m = cnpkg3_mapdim_layers_bkwd(m,imSz,1);
	else,
		m = cnpkg3_mapdim_layers_fwd(m,imSz,1);
	end
