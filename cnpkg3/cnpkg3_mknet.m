...
m.params.layer{l}.patchSz{end+1} = [[1 1]*11 1];
m.params.layer{l}.wPxSize{end+1} = [[1 1]*1 1];
m.params.layer{l}.nHid{end+1} = 2;
m.params.layer{l}.scales{end+1} = [1 1 1];
m.params.layer{l}.patchSz{end+1} = [[1 1]*7 1];
...
m.params.layer{l}.nHid{end+1} = 2;
m.params.layer{l}.scales{end+1} = [1 1 1];
m.params.layer{l}.patchSz{end+1} = [[1 1]*3 1];
m.params.layer{l}.wPxSize{end+1} = [[1 1]*7 1];
...
m.params.layer{m.params.num_layers}.patchSz{1} = [[1 1]*5 1];
