...
l = l(end) + (1:(m.params.num_layers-1));
m.layer_map.big_hidden = l;
l = l(end) + 1;
m.layer_map.big_output = l;
l = l(end) + 1;
m.layer_map.big_label = l;
m.layer_map.big_hidden_prev_layer = [m.layer_map.big_input m.layer_map.big_hidden(1:end-1)];
m.layer_map.big_hidden_next_layer = [m.layer_map.big_hidden(2:end) m.layer_map.big_output];


%% Fill in the cnpkg layer parameters
% big_minibatch index layer
...
m.layers{l}.size{5} = 1;
m.layers{l}.zl = m.layer_map.big_label;
% big_output layer
