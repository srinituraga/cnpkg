...
* If the MCR is not installed, run MCRInstaller, located in:
  ...
  /usr/local/matlab_2009b/toolbox/compiler/deploy/glnxa64/MCRInstaller.bin
...
================================
-train1012 
-run_train1012.sh (shell script run to
     ...
     ii. Set the path by doing one of the following:
        ...
        * Add the MCR directory to the environment variable by issuing 
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_train1012.sh 
